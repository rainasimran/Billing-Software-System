...
class Bill_App:
    def __init__(self,root):
        ...
        bg_color="#074463"
        title=Label(self.root,text="Billing Software",bd=10, relief=GROOVE, bg=bg_color,fg="white", font=("times new roman",30,"bold")).pack(fill=X)
        #========variables========
        #======cosmetics
        self.soap=IntVar()
        ...
        #=========total product price and tax values=====
        ...
        cphn_txt=Entry(F1,width=15, textvariable=self.c_phon,font="arial 15",bd=7,relief=SUNKEN).grid(row=0, column=3,padx=5,pady=10)
        ...
        c_bill_txt=Entry(F1,width=15, textvariable=self.search_bill, font="arial 15",bd=7,relief=SUNKEN).grid(row=0, column=5,padx=5,pady=10)
        ...
        F3=LabelFrame(self.root,text="Grocery", font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END,"\tWelcome Deepti Retail Store\n")
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phon.get=="":
            messagebox.showerror("Error","Customer Details are Must Entered")
